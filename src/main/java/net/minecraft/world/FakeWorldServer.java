...
import misterpemodder.configurablelightning.CLHandler;
...
public class FakeWorldServer extends WorldServer implements IThreadListener {
	   private static final Logger LOGGER = LogManager.getLogger();
	    ...
	    private final WorldServer.ServerBlockEventList[] blockEventQueue = new WorldServer.ServerBlockEventList[] {null, null};
	    ...
	    protected void updateBlocks()
	    {
	        ...
	        if (this.worldInfo.getTerrainType() == WorldType.DEBUG_WORLD)
	        {
	            ...
	            for (Iterator<Chunk> iterator = getPersistentChunkIterable(this.playerChunkMap.getChunkIterator()); iterator.hasNext(); this.theProfiler.endSection())
	            {
	                ...
	                if (this.provider.canDoLightning(chunk) && flag && flag1 && CLHandler.shouldDoLightning(this, rand))
	                {
	    ...
	    protected BlockPos adjustPosToNearbyEntity(BlockPos pos)
	    {
	        ...
	        List<EntityLivingBase> list = this.getEntitiesWithinAABB(EntityLivingBase.class, axisalignedbb, new Predicate<EntityLivingBase>()
	        {
	            ...
	            {
	                return p_apply_1_ != null && p_apply_1_.isEntityAlive() && FakeWorldServer.this.canSeeSky(p_apply_1_.getPosition());
	            }
	        });
